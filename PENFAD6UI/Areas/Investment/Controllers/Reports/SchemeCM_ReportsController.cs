...
{
    public class SchemeCM_ReportsController : Controller
    {
        cLogger logger = new cLogger();
        readonly pfm_Scheme_FundRepo SFRepo = new pfm_Scheme_FundRepo();

        public ActionResult AddCMTab(string containerId = "MainArea")
        {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/MM_TBILL_BOND_COUPON_S.dll");
        ...
        public StoreResult GetChildren()
        {
            ...
            string con = "ReportPCMStatementPartial";
            //int y = 0;
            for (int i = 1; i <= 1; i++)
            {
        ...
        {
            X.Mask.Hide();
            return PartialView("ReportCMStatementPartial");
        }
