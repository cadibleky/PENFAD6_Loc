    ...
    public class DashboardController : Controller
    {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/MM_TBILL_BOND_DB.dll");
                ...
                //{
                //    string pa = Server.MapPath("~/Penfad_Reports/EC_DB.dll");
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId, string Scheme_Fund_Id, string tree_node_id, DateTime? Report_Date)
        {
            try
            {
                ...
                con.GetConnection().Execute("REPORT_INSERT_PORT_SUM_DB", param, commandType: CommandType.StoredProcedure);
                X.Mask.Hide();
