    ...
    public class ReportsController : Controller
    {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
				...
				//con.GetConnection().Execute("REPORT_INSERT_PORT_SUM", param, commandType: CommandType.StoredProcedure);


				if (GlobalValue.Report_Index_Id == "employee_report1")
                {
                    string pa = Server.MapPath("~/Penfad_Reports/MM_TBILL_BOND_PV.dll");
