...
{
    public class Report_YearlyTBController : Controller
    {
        // GET: report
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                if (GlobalValue.Report_Index_Id == "employer_report1")
                {
					...
					//load report
					string pa = Server.MapPath("~/Penfad_Reports/CINAAFB.dll");
				...
				else if (GlobalValue.Report_Index_Id == "employer_report2")
				{
					...
					string pa = Server.MapPath("~/Penfad_Reports/NAAFB.dll");
				...
				else if (GlobalValue.Report_Index_Id == "employer_report3")
				{
					...
					string pa = Server.MapPath("~/Penfad_Reports/MTB.dll");
				...
				else if (GlobalValue.Report_Index_Id == "employer_report4")
				{
					...
					string pa = Server.MapPath("~/Penfad_Reports/YTB.dll");
                ...
                else if (GlobalValue.Report_Index_Id == "employer_report5")
                {
                    ...
                    string pa = Server.MapPath("~/Penfad_Reports/CASHFLOW.dll");
