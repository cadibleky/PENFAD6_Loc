...
{
    public class Report_Ledger_AccountConsolidatedController : Controller
    {
        // GET: report
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/LEDGER_ACCOUNT_CONSOLIDATED.dll");
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId, string Account_Name)
        {
            if (string.IsNullOrEmpty(Account_Name))
            {
                ...
                {
                    Title = "Error",
                    Message = "Select Merge GL Account.",
                    Buttons = MessageBox.Button.OK,
                    Icon = MessageBox.Icon.INFO,
                    Width = 350
            ...
            GlobalValue.Report_Param_1 = Account_Name;
        ...
        public ActionResult GetGLAB(string Scheme_Id)
        {
            ...
            var mydata = misdepartmentrepo.GetGLASFListGLScheme(Scheme_Id);

            List<object> data = new List<object>();
            foreach (var ddd in mydata)
            {
                string id = ddd.Account_Name;
                string name = ddd.Account_Name;
