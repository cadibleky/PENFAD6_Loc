...
{
    public class Report_DailyFeesController : Controller
    {
        // GET:
        cLogger logger = new cLogger();
        readonly pfm_SchemeRepo schemeRepo = new pfm_SchemeRepo();

        public ActionResult Report_DailyFees_Tab(string containerId = "MainArea")
        {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                if (GlobalValue.Report_Index_Id == "employee_report1")
                {
                    ...
                    string pa = Server.MapPath("~/Penfad_Reports/DNAB_FEES.dll");
					...
					My_Report[":P_FEEID"] = GlobalValue.Report_Param_2_string;
        ...
        {
            return PartialView("Report_DailyFeesPartial");
        }
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId, string Scheme_Id, string Fee_Id, string tree_node_id)
        {
			...
			GlobalValue.Report_Param_2_string = Fee_Id;
