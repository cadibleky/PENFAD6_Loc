...
{
    // ===================================
    public class EmployeeBatchEditController : Controller
    {
        ...
        public ActionResult AddEmployeeBatchEditTab(string containerId = "MainArea")
        {
            try
            {
                var pvr = new Ext.Net.MVC.PartialViewResult
                {
                    ViewName = "EmployeeBatchEditPartial", //"EmployeeBatchPatial",
                    //Model = empList,
        ...
        public ActionResult UploadNewBatchEmployee(crm_EmployeeBatchLogRepo crmEmployeelog_repo)
        {
            ...
            try
            {
                ...
                if (this.GetCmp<FileUploadField>("file_upload1_batchedit").HasFile)
                {
                    HttpPostedFile file_posted = this.GetCmp<FileUploadField>("file_upload1_batchedit").PostedFile;
                                ...
                                while (srda.Read())
                                {
                                    ...
                                    if (srda["CompanyEmployeeID"] != DBNull.Value)
                                    {
                                        ...
                                        if (total == 0)
                                        {
                                            ...
                                            error_nos += 1;
                                            erroor_msg = erroor_msg + "Employee ID does not exist For this employer. - " + employee_Repo.Surname + " " + employee_Repo.First_Name + Environment.NewLine;
                                            //get custNo
                                    ...
                                    param.Add(name: "p_CustNo", value: employee_Repo.Cust_No, dbType: DbType.String, direction: ParameterDirection.Input);
                                    param.Add(name: "p_EmployeeId", value: employee_Repo.Employee_Id, dbType: DbType.String, direction: ParameterDirection.Input);
                                    //param.Add(name: "p_EmployerId", value: employeeRepo.Employer_Id, dbType: DbType.String, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_DateofBirth", value: employee_Repo.Date_Of_Birth, dbType: DbType.DateTime, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_Nationality", value: employee_Repo.Nationality, dbType: DbType.String, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_SSNIT_NO", value: employee_Repo.SSNIT_NO, dbType: DbType.String, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_Position", value: employee_Repo.Position, dbType: DbType.String, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_FatherBirthDate", value: employee_Repo.Father_Birth_Date, dbType: DbType.DateTime, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "p_MotherBirthDate", value: employee_Repo.Mother_Birth_Date, dbType: DbType.DateTime, direction: ParameterDirection.Input);
                                    param.Add(name: "p_Profession", value: employee_Repo.Profession, dbType: DbType.String, direction: ParameterDirection.Input);
                                    ...
                                    param.Add(name: "P_ResidentCity", value: employee_Repo.Resident_City, dbType: DbType.String, direction: ParameterDirection.Input);
                                    param.Add(name: "p_ResidentDistrict", value: employee_Repo.Resident_District, dbType: DbType.String, direction: ParameterDirection.Input);
                                    param.Add(name: "p_ResidentRegion", value: employee_Repo.Resident_Region, dbType: DbType.String, direction: ParameterDirection.Input);
                                    conn.Execute(sql: "UPD_CRM_EMPLOYEEBATCH_S", param: param, commandType: CommandType.StoredProcedure);
