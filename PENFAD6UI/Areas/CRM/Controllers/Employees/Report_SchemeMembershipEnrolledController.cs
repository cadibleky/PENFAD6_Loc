...
{
    public class Report_SchemeMembershipEnrolledController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembership_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeEnrolledPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_per_Scheme_Enrolled.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipEnrolledPartial");
        }
