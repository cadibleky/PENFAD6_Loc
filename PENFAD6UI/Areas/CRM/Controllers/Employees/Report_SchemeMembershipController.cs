...
{
    public class Report_SchemeMembershipController : Controller
    {
        // GET:
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_per_Scheme.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipPartial");
        }
