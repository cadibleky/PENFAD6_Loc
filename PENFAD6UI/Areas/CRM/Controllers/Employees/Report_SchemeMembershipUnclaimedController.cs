...
{
    public class Report_SchemeMembershipUnclaimedController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembershipUnclaimed_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeUnclaimedPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_Unclaimed_Scheme.dll");
					...
					My_Report[":P_RSID"] = GlobalValue.Report_Param_1;
                    My_Report[":P_RDAY"] = GlobalValue.Report_Param_2;
        ...
        {
            return PartialView("Report_SchemeMembershipUnclaimedPartial");
        }
		...
		public ActionResult GetGLAB(string Scheme_Id)
		{
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { conlist_GLB_gIdUnclaimed = id, conName = name });
			}
