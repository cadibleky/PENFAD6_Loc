...
{
    public class Report_Monthly_Schedule_SchemePaidController : Controller
    {
        // GET:
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Monthly_Schedule_SchemePaid.dll");
		...
		public ActionResult GetGLAB(string Scheme_Id)
		{
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { ScheduleSchemePaidlist_GLB_gId = id, conName = name });
			}
