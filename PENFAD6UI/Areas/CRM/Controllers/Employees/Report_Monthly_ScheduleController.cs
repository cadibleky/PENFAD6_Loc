...
{
    public class Report_Monthly_ScheduleController : Controller
    {
        // GET:
		...
		public ActionResult Report_MS_Tab(string containerId = "MainArea")
        {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Monthly_Schedule.dll");
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId, string ES_Id, string tree_node_id, String con_month)
        {
		...
		public ActionResult GetGLAB(string ES_Id)
		{
			var misdepartmentrepo = new Remit_Contribution_Upload_LogRepo();
			var mydata = misdepartmentrepo.GetGLASFList2(ES_Id);
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { Schedulelist_GLB_gId = id, conName = name });
			}
