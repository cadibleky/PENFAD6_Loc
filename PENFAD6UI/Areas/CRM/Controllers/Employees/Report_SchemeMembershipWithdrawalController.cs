...
{
    public class Report_SchemeMembershipWithdrawalController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembership_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeWithdrawalPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_per_Scheme_Withdrawal.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipWithdrawalPartial");
        }
