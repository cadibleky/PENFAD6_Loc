...
{
    public class Report_SchemeMembershipSalaryController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembership_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeSalaryPartial",
                    //Model = empRepoList,
        ...
        {
            return PartialView("Report_SchemeMembershipSalaryPartial");
        }
