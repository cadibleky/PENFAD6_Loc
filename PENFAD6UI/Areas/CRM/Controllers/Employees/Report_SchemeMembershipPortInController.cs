...
{
    public class Report_SchemeMembershipPortInController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembership_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemePortInPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_per_Scheme_PortIn.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipPortInPartial");
        }
