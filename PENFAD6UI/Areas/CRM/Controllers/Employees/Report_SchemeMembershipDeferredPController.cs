...
{
    public class Report_SchemeMembershipDeferredPController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembershipDeferredP_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeDeferredPPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_DeferredP_Scheme.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipDeferredPPartial");
        }
		...
		public ActionResult GetGLAB(string Scheme_Id)
		{
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { conlist_GLB_gIdDeferredP = id, conName = name });
			}
