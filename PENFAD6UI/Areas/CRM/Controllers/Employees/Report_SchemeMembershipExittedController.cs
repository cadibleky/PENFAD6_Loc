...
{
    public class Report_SchemeMembershipExittedController : Controller
    {
        // GET:
		...
		public ActionResult Report_SchemeMembership_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeExittedPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employee_List_per_Scheme_Exitted.dll");
        ...
        {
            return PartialView("Report_SchemeMembershipExittedPartial");
        }
