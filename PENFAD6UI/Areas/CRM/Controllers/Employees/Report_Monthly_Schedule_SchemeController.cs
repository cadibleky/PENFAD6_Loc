...
{
    public class Report_Monthly_Schedule_SchemeController : Controller
    {
        // GET:
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Monthly_Schedule_Scheme.dll");
                    ...
                    My_Report[":P_TO_DATE"] = GlobalValue.Report_Param_2;
                    My_Report[":P_FROM_DATE"] = GlobalValue.Report_Param_1_date;
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId, string Scheme_Id, string tree_node_id, String con_month, DateTime? To_Date, DateTime? From_Date)
        {
		...
		public ActionResult GetGLAB(string Scheme_Id)
		{
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { ScheduleSchemelist_GLB_gId = id, conName = name });
			}
