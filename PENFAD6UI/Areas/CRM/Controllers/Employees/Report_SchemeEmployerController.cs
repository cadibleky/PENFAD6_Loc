...
{
    public class Report_SchemeEmployerController : Controller
    {
        // GET:
        cLogger logger = new cLogger();
        readonly pfm_SchemeRepo schemeRepo = new pfm_SchemeRepo();

        public ActionResult Report_SchemeEmployer_Tab(string containerId = "MainArea")
        {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Employer_List_Scheme.dll");
        ...
        {
            return PartialView("Report_SchemeEmployerPartial");
        }
