...
{
    public class Report_Monthly_Schedule_DefaultersController : Controller
    {
        // GET:
		...
		public ActionResult Report_MSSD_Tab(string containerId = "MainArea")
        {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                ...
                {
                    string pa = Server.MapPath("~/Penfad_Reports/Monthly_Schedule_Defaulters.dll");
		...
		public ActionResult GetGLAB(string Scheme_Id)
		{
			...
			foreach (var ddd in mydata)
			{
				...
				data.Add(new { ScheduleDefaulterslist_GLB_gId = id, conName = name });
			}
