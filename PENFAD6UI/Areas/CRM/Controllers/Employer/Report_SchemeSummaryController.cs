...
{
    public class Report_SchemeSummaryController : Controller
    {
        ...
        public ActionResult Report_Scheme_Tab(string containerId = "MainArea")
        {
            ...
            try
            {
                ...
                {
                    ViewName = "Report_SchemeSPartial",
                    //Model = empRepoList,
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                if (GlobalValue.Report_Index_Id == "SCHEME_FUND_SUMMARY")
                {
                    string pa = Server.MapPath("~/Penfad_Reports/SCHEME_FUND_SUMMARY.dll");
        ...
        {
            return PartialView("Report_SchemeSummaryPartial");
        }
        ...
        public ActionResult Load_Employee_Report_IFrame(string containerId = "z_mainform_center_panel_tab_main_1")
        {
            ...
            GlobalValue.Report_Index_Id = "SCHEME_FUND_SUMMARY";
