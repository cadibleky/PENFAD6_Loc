...
{
    public class Report_EmployerStatementController : Controller
    {
        ...
        public ActionResult GetReportSnapshot()
        {
            try
            {
                if (GlobalValue.Report_Index_Id == "employer_report1")
                {
                    ...
                    string pa = Server.MapPath("~/Penfad_Reports/Employer_Scheme_Con_Monthly_1.dll");
        ...
        {
            return PartialView("Report_EmployerStatementPartial");
        }
        ...
        public ActionResult Read2(string Employer_Id)
        {
            try
            {
                ...
                X.GetCmp<Store>("Report_EmployeePartial_employeeStore").Reload();
