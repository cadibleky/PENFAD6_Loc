...
{
    public class EndOfDayBackController : Controller
    {
        ...
        public ActionResult AddEODTab(string containerId = "MainArea")
        {
            try
            {
        ...
        public ActionResult AddEODAllTab(string containerId = "MainArea")
        {
            try
            {
                var pvr = new Ext.Net.MVC.PartialViewResult
                {
                    ViewName = "EODAllPartial",
                    ContainerId = containerId,
                    RenderMode = RenderMode.AddTo,
                };
                this.GetCmp<TabPanel>(containerId).SetLastTabAsActive();
        ...
        public ActionResult RunEOD(EndOfDayRepo EODRepo)
        {
            ...
            //check if scheme date is valid for end of day
