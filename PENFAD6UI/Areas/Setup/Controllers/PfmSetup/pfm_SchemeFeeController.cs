...
{
    public class pfm_SchemeFeeController : Controller
    {
        ...
        public void ClearControls()
        {
            try
            {
                var x = X.GetCmp<FormPanel>("frmsetupSF");
                x.Reset();
            }
        ...
        public ActionResult AddSchemeFeeTab(string containerId = "MainArea")
        {
            try
            { 
            var pvr = new Ext.Net.MVC.PartialViewResult
            {
                ViewName = "SchemeFeePartial",
        ...
        public ActionResult Read()
        {
            try
            { 
            return this.Store(SchemeFeeRepo.GetSchemeFeeList());
            }
            catch (System.Exception)
            {
