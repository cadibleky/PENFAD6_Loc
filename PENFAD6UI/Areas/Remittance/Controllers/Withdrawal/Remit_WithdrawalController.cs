...
{
    public class Remit_WithdrawalController : Controller
    {
        ...
        public ActionResult GetGLAB(string Scheme_Fund_Id)
        {
            ...
            foreach (var ddd in mydata)
            {
                ...
                data.Add(new { wPay_GLB_gId = id, gName = name });
            }
        ...
        public ActionResult GetGLaccPay(string GL_Account_No)
        {
            ...
            foreach (var ddd in mydata)
            {
                ...
                data.Add(new { WPaymId = id, mName = name });
            }
        ...
        public ActionResult DisapproveRecord(string Withdrawal_No)
        {
            try
            {
                ...
                WithdrawalRepo.DisapproveWithdrawalRecord(Withdrawal_No);
                X.Msg.Show(new MessageBoxConfig
                {
                    Title = "Success",
        ...
        public ActionResult ReadWithdrawalReverse()
        {
            try
            {
                return this.Store(WithdrawalRepo.GetWithdrawalReverseList());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ActionResult ReadWithdrawalPending()
        {
            try
            {
              return this.Store( WithdrawalRepo.GetWithdrawalPendingList());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ActionResult GetUPrice(Remit_WithdrawalRepo WithdrawalRepo)
        {
            try
            {
                ...
                this.GetCmp<TextField>("Withdrawal_TotalB").SetValue(WithdrawalRepo.Unit_Price * WithdrawalRepo.Total_Unit_Balance);
                return this.Direct();
            }
            catch (Exception ex)
            {
