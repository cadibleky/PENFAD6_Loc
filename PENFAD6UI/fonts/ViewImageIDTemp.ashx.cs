...
namespace PENFAD6UI.fonts
{
    /// <summary>
    /// Summary description for ViewImageIDTemp
    /// </summary>
    public class ViewImageIDTemp : IHttpHandler
    {
        ...
        public Stream DisplayKYCImage(string Cust_No)
        {
            try
            {
                ...
                cmd.CommandText = "Select Employee_Photo_ID from crm_Employee_temp where Cust_No=  '" + Cust_No + "'";
