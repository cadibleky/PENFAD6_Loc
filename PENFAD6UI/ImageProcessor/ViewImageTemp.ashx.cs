...
{
    /// <summary>
    /// Summary description for ViewImageTemp
    /// </summary>
    public class ViewImageTemp : IHttpHandler
    {
        ...
        public Stream DisplayKYCImage(string Cust_No)
        {
            try
            {
                ...
                cmd.CommandText = "Select Employee_Photo from crm_Employee_temp where Cust_No=  '" + Cust_No + "'";
