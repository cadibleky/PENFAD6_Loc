...
{
    /// <summary>
    /// Summary description for ViewImageProcessor
    /// </summary>
    public class ViewImageProcessor : IHttpHandler
    {
        ...
        public Stream DisplayKYCImage(string Cust_No)
        {
            try
            {
                ...
                cmd.CommandText = "Select Employee_Photo from crm_Employee where Cust_No=  '" + Cust_No + "'";
