...
namespace PENFAD6DAL.Repository.GL
{
    public class GLJournalRepo
    {
        ...
        [Required(ErrorMessage = "Please select Debit Account.")]
        public string Debit_Gl_No { get; set; }
        public string Debit_Gl_Name { get; set; }
        public decimal Debit_Gl_Balance { get; set; }
        [Required(ErrorMessage = "Please select Credit Account.")]
        public string Credit_Gl_No { get; set; }
        public string Credit_Gl_Name { get; set; }
        public decimal Credit_Gl_Balance { get; set; }
        [Required]
        ...
        public void Get_BalanCredit(GLJournalRepo GLRepo)
        {
            try
            {
                ...
                param.Add("VDATA", null, DbType.Decimal, ParameterDirection.Output);
                param.Add("VDATA2", "", DbType.String, ParameterDirection.Output);
                con.GetConnection().Execute("SEL_GL_CREDITBALANCE2", param, commandType: CommandType.StoredProcedure);
                GLRepo.Credit_Gl_Balance = param.Get<decimal>("VDATA");
                GLRepo.Memo_Code = param.Get<string>("VDATA2");
        ...
        public bool Approve_Journal(GLJournalRepo GLRepo)
        {
            ...
            using (OracleConnection conn = new OracleConnection(app.conString()))  //
            {
                ...
                try
                {
                    ...
                    param_gl.Add(name: "P_AUTH_DATE", value: GLRepo.Trans_Date, dbType: DbType.DateTime, direction: ParameterDirection.Input);
