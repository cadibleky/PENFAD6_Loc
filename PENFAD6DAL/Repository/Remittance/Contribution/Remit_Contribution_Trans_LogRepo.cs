...
{
    public class Remit_Contribution_Trans_LogRepo
    {
       ...
       public decimal Employee_Amt_Touse_Temp { get; set; }
        ...
        public IEnumerable<Remit_Contribution_Trans_LogRepo> GetEmployerList()
        {
            try
            {
        ...
        public List<Remit_Contribution_Trans_LogRepo> GetEmployeeCon_BatchList_ByStatus(string batchLogno)
        {
            var batch_list = new List<Remit_Contribution_Trans_LogRepo>();
            var app = new AppSettings();
                ...
                try
                {
                    ...
                    using (OracleCommand cmd = new OracleCommand())
                    {
                        ...
                        using (OracleDataAdapter da = new OracleDataAdapter(cmd))
                        {
                            ...
                            da.Fill(dt);
                            batch_list = dt.AsEnumerable().Select(row => new Remit_Contribution_Trans_LogRepo
                            {
...
public IEnumerable GetRemit_EmployerScheme_Dataset(string emplid, string Schemeid)
{
  ...
  if (result < 0)
        ...
        public List<Remit_Contribution_Trans_LogRepo> Get_Crm_Employer_SchemeByStatus(string Es_status)
        {
