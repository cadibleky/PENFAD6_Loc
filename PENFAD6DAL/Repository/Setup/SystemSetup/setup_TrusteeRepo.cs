...
{
    public class setup_TrusteeRepo
    {
        //Richard.................................
        public string Trustee_Id { get; set; }

        [Required(ErrorMessage ="Trustee Name is a required data item.")]
        ...
        public DataSet TrusteeData()
        {
            try
            {
                ...
                cmd.CommandText = "SEL_SETUP_TRUSTEE";
        ...
        public IEnumerable<setup_TrusteeRepo> GetTrusteeList()
        {
            try
            {
                DataSet dt = TrusteeData();
                var eList = dt.Tables[0].AsEnumerable().Select(row => new setup_TrusteeRepo
                {
                    Trustee_Id = row.Field<string>("TRUSTEE_ID"),
